        ...
        <ul>
          ...
          <li class="news-article row">
            ...
            <div class="news-content">
              <p>
                Here is an article which features numerous infographics done by me.
              </p>
            </div><!-- .news-content -->
          ...
          <li class="news-article row">
            ...
            <h4 class="news-title">
              <a href="http://pubs.acs.org/action/showLargeCover?jcode=acncdm&vol=4&issue=4&" title="Read Article" target="_blank">ACS Chemical Neuroscience Cover</a>
            </h4>
            
            <p class="news-meta">Posted on <em>April 30, 2013</em></p>
            
            <div class="news-content">
              <p>
                Here is the cover of ACS Chemical Neuroscience where I had an opportunity to participate with my image.
              </p>
            </div><!-- .news-content -->
            
              <a href="http://pubs.acs.org/action/showLargeCover?jcode=acncdm&vol=4&issue=4&" title="Read Article" target="_blank"><span class="read-more right">Read More >></span></a>
          </li><!-- .news-article -->
